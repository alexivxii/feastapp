            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Text("Explore", style: TextStyle(fontSize: 26, color: Color(0xffff682c), fontWeight: FontWeight.w500,),),
                ],
              ),
            ),
            Flexible(
                                              ...
                                              children: [
                                                ...
                                                Container(
                                                  margin: EdgeInsets.only(top:5),
                                                    child: Row(
                                                      children: [
                                                        Text(snapshot.data.docs[index].data()["Name"], style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600),),
                                                        Expanded(
                                                          child: Container(
                                                ...
                                                Container(
                                                  alignment: Alignment.centerLeft,
                                                  margin: EdgeInsets.only(top:5),
                                                  child: Text("Address: ${snapshot.data.docs[index].data()["Address"]}", style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600),),
                                                )
                                              ],
                                            ),
                                          ),
